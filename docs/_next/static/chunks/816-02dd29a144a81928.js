...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+material@6.4.12_@emotion+react@11.14.0_@types+react@19.1.8_react@19.1.0__@emotion+styled_7n6ip7adzgskiknwagt7k5dnla/node_modules/@mui/material/Autocomplete/Autocomplete.js + 8 modules
var Autocomplete = __webpack_require__(71109);
...
var Select = __webpack_require__(60924);
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+material@6.4.12_@emotion+react@11.14.0_@types+react@19.1.8_react@19.1.0__@emotion+styled_7n6ip7adzgskiknwagt7k5dnla/node_modules/@mui/material/MenuItem/MenuItem.js + 4 modules
var MenuItem = __webpack_require__(18743);
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+icons-material@6.4.12_@mui+material@6.4.12_@emotion+react@11.14.0_@types+react@19.1.8_re_5ewkm5t5g27pzq5tz62v6ktvti/node_modules/@mui/icons-material/esm/PlayCircleOutline.js
var PlayCircleOutline = __webpack_require__(68816);
...
;// ./src/components/pre-alarm-config/index.tsx
...
const SortableItem = (param)=>{
    let { action, onUpdate, onRemove } = param;
    ...
    function handlePreviewSound(id) {
        const script = '\n        com.fanfanlo.emergencycall.manager.SoundManager.previewSound("'.concat(id, '");\n        ');
        ...
        children: [
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsxs)(Stack/* default */.A, {
                ...
                children: [
                    /*#__PURE__*/ (0,jsx_runtime.jsxs)(Box/* default */.A, {
                        ...
                        children: [
                            /*#__PURE__*/ (0,jsx_runtime.jsx)(Chip/* default */.A, {
                                label: action.type === 'sound' ? '声音' : '震动',
                                color: action.type === 'sound' ? 'primary' : 'secondary',
                                size: "small"
                            }),
                            /*#__PURE__*/ (0,jsx_runtime.jsx)(IconButton/* default */.A, {
                                size: "small",
                    ...
                    action.type === 'sound' && /*#__PURE__*/ (0,jsx_runtime.jsxs)(Box/* default */.A, {
                        sx: {
                            display: 'flex',
                            gap: 1,
                            alignItems: 'center'
                        ...
                        children: [
                            /*#__PURE__*/ (0,jsx_runtime.jsxs)(FormControl/* default */.A, {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0,jsx_runtime.jsx)(Select/* default */.A, {
                                        ...
                                        children: defaultSoundResources.map((res)=>/*#__PURE__*/ (0,jsx_runtime.jsx)(MenuItem/* default */.A, {
                                                value: res.id,
                                                children: res.name
                                            }, res.id))
                                    })
                            ...
                            /*#__PURE__*/ (0,jsx_runtime.jsx)(IconButton/* default */.A, {
                                ...
                                size: "small",
                                children: /*#__PURE__*/ (0,jsx_runtime.jsx)(PlayCircleOutline/* default */.A, {})
                            })
                        ]
                    })
                ]
...
const PreAlarmConfigComponent = ()=>{
    ...
    (0,react.useEffect)(()=>{
        const fetchConfig = async ()=>{
            ...
            if (storedConfig && typeof storedConfig === 'object') {
                const actionsWithIds = storedConfig.actions.map((a)=>({
                        ...a,
    ...
    const handleRemoveAction = (id)=>{
        handleConfigChange({
            actions: config === null || config === void 0 ? void 0 : config.actions.filter((a)=>a.id !== id)
        });
    };
    const handleUpdateAction = (id, updates)=>{
        handleConfigChange({
            actions: config === null || config === void 0 ? void 0 : config.actions.map((a)=>a.id === id ? {
                    ...a,
                    ...updates
                } : a)
        });
    ...
    const handleDragEnd = (event)=>{
        ...
        if (over && active.id !== over.id) {
            setConfig((prev)=>{
                ...
                const newActions = (0,sortable_esm/* arrayMove */.be)(prev.actions, oldIndex, newIndex);
                ...
                /*#__PURE__*/ (0,jsx_runtime.jsx)(core_esm/* DndContext */.Mp, {
                    ...
                    children: /*#__PURE__*/ (0,jsx_runtime.jsx)(sortable_esm/* SortableContext */.gB, {
                        ...
                        children: /*#__PURE__*/ (0,jsx_runtime.jsx)(List/* default */.A, {
                            disablePadding: true,
                            children: config.actions.map((action)=>/*#__PURE__*/ (0,jsx_runtime.jsx)(SortableItem, {
                                    action: action,
...
/* harmony default export */ const pre_alarm_config = (PreAlarmConfigComponent);
...
function Content() {
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)(Box/* default */.A, {
        ...
        children: [
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsx)(pre_alarm_config, {}),
...
//# sourceMappingURL=816-02dd29a144a81928.js.map
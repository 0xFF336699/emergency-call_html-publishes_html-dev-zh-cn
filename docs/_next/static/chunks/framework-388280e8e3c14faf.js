...
if (true) {
    ...
    checkDCE();
    module.exports = __webpack_require__(7364);
} else {}
...
if (true) {
    ...
    // DevTools can report bad minification during injection.
    checkDCE();
    module.exports = __webpack_require__(7554);
} else {}
...
*/ 
var Scheduler = __webpack_require__(9950), React = __webpack_require__(4285), ReactDOM = __webpack_require__(5088);
function formatProdErrorMessage(code) {
    var url = "https://react.dev/errors/" + code;
    if (1 < arguments.length) {
        url += "?args[]=" + encodeURIComponent(arguments[1]);
...
//# sourceMappingURL=framework-388280e8e3c14faf.js.map
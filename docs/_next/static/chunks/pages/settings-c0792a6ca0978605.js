...
/***/ ((__unused_webpack_module, __unused_webpack_exports, __webpack_require__) => {
    ...
    (window.__NEXT_P = window.__NEXT_P || []).push([
      "/settings",
      function () {
        return __webpack_require__(53516);
      }
    ]);
    if(false) {}
...
var User = __webpack_require__(93472);
...
;// ../../libs/fanfanlo/src/react/AsyncContextLoader.tsx
/**
 * 使用场景：
 * 
...
// export function TypedContextLoader<T extends Record<string, any>>(props: {context: Promise<IStoreWithData<T>>}){
//     const {context: promise} = props;
//     const store = use(promise);
...
//     return <>{value}</>
// }
// type TypedContextLoaderProps<T extends Record<string, any>> = {
//     context: Promise<IStoreWithData<T>>;
//     Provider: React.ComponentType<{ value: T; children?: React.ReactNode }>;
//     children?: React.ReactNode;
//   };
//   export function TypedContextLoader<T extends Record<string, any>>({ context, Provider, children }: TypedContextLoaderProps<T>) {
//     const store = use(context); // React 19 use() 等待 Promise 结果
//     return <Provider value={store.data}>{children}</Provider>;
//   }
function createAsyncContextLoader(options) {
    ...
    return function AsyncContextLoader(props) {
        return /*#__PURE__*/ (0,jsx_runtime.jsx)(react.Suspense, {
            fallback: fallback,
            children: /*#__PURE__*/ (0,jsx_runtime.jsx)(AsyncContextLoaderInner, {
                ...props
            })
        });
    };
...
;// ../../libs/fanfanlo/src/react/createTypedContext.ts
...
;// ./src/components/fallback/Fallback.tsx


function Fallback() {
    const { t } = (0,es/* useTranslation */.Bd)('homepage/components/fallback/content');
...
;// ./src/components/pages/settings/data/settings.context.tsx




const [SettingsPageDataContextProvider, useSettingsPageData] = createTypedContext();
const SettingsPageDataContextLoader = createAsyncContextLoader({
    Provider: SettingsPageDataContextProvider,
    extract: (res)=>res.data,
    fallback: /*#__PURE__*/ (0,jsx_runtime.jsx)(Fallback, {})
});

// EXTERNAL MODULE: ../../libs/fanfanlo/src/storage/store-utils.ts
var store_utils = __webpack_require__(4887);
;// ./src/components/pages/settings/data/ns.ts
const ns = 'settings';
...
;// ./src/components/pages/settings/data/settings.data.intf.ts
...
/******/ __webpack_require__.O(0, [299,898,97,636,593,792], () => (__webpack_exec__(45520)));
